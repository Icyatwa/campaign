...
function WebsitesBarChart() {
  const data = [
    { name: 'Aime Rwanda 250', visitors: 750 },
    { name: 'Clapton Kibonke', visitors: 1200 },
    { name: 'Nishimwe Naomi', visitors: 2100 },
    { name: 'Solange Nishimwe', visitors: 1800 },
    { name: 'Ngabo Karegeya', visitors: 3200 },
    { name: 'Zuba Mutesi', visitors: 2800 },
    { name: 'The Long Form', visitors: 1500 }
  ];
